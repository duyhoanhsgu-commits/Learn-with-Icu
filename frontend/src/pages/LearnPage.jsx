...
function WorkspaceWelcome({ space, files }) {
  ...
  return <div className="mx-auto flex h-full w-full max-w-[760px] flex-col items-center justify-center px-5 py-10 text-center sm:px-8">
    <BrandLogo className="h-12 w-12 rounded-2xl border border-line bg-white p-1 shadow-[0_4px_16px_rgba(15,23,42,.06)]" />
    <p className="mt-5 flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[.2em] text-brandblue"><Sparkles size={13} />Learning assistant</p>
    <h3 className="mt-2 font-['Manrope'] text-2xl font-bold tracking-[-.025em] text-ink sm:text-[28px]">Welcome to your learning space.</h3>
    <p className="mt-3 max-w-[520px] text-[13px] leading-6 text-muted">Ask across your uploaded materials, simplify difficult ideas, create summaries, or generate a study tool when you are ready.</p>
    <div className="mt-7 flex w-full max-w-[640px] items-center gap-3 rounded-[18px] border border-line bg-white p-3.5 text-left">
